...
function Navigation() {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-50 px-6 py-4 md:px-8 border-b border-emerald-950/10 bg-brand-dark/80 backdrop-blur-md flex justify-between items-center pointer-events-none">
      <div className="flex items-center gap-3 pointer-events-auto cursor-hover group">
      ...
      {/* Desktop Nav */}
      <div className="hidden md:flex gap-8 text-[10px] uppercase tracking-[0.2em] font-medium text-emerald-950/50 pointer-events-auto">
      ...
      <div className="flex items-center gap-4 pointer-events-auto">
        <a href="#contact" className="hidden md:block px-5 py-2 border border-emerald-950/20 rounded-full text-[10px] uppercase tracking-widest text-emerald-950 hover:bg-emerald-950 hover:text-white transition-all cursor-hover cursor-none">
          Start Project
        </a>
        <button 
